...
<div style="margin-bottom: 2rem;">
    <p class="text-slate-500 text-sm">Kelola seluruh metadata, Open Graph, dan indexability halaman utama Rootera secara terpusat untuk optimasi mesin pencari.</p>
</div>
