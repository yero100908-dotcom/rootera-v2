...
<div class="admin-layout">
    ...
    <aside class="sidebar" id="adminSidebar" role="navigation" aria-label="Admin navigation">
        ...
        $nav = [
            ...
            ['route'=>'admin.gallery.index','label'=>'Galeri Foto & Video','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>'],
        ...
        <div style="padding:.75rem 0;flex:1">
            ...
            <a href="{{ route('admin.project-galleries.index') }}" class="sidebar-link {{ request()->routeIs('admin.project-galleries.*') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><polyline points="11 3 11 11 14 8 17 11 17 3"/><line x1="9" y1="21" x2="9" y2="9"/></svg>
                Portofolio Proyek
            </a>
    ...
    <div class="admin-main">
        ...
        <main class="admin-content p-4 sm:p-6 lg:p-8">
            ...
            @endif
            @if($errors->any())
            <div style="background:#fef2f2;border:1px solid #fee2e2;color:#dc2626;padding:1rem 1.25rem;border-radius:12px;margin-bottom:1.5rem">
                ...
                <ul style="margin:0;padding-left:1.5rem;font-size:0.88rem">
            ...
            <script>
                // Auto-open modal if there are errors so user doesn't have to click "Tambah Baru" again
                document.addEventListener('DOMContentLoaded', function() {
                    if (document.getElementById('galleryModal')) {
                        document.getElementById('galleryModal').style.display = 'flex';
                        setTimeout(() => {
                            document.getElementById('galleryModal').style.opacity = '1';
