<section class="section" aria-labelledby="faq-heading" style="position: relative; overflow: hidden; background-color: #ffffff;">
    ...
    <div class="container" style="position: relative; z-index: 10;">
        ...
        <div class="text-center" style="margin-top: 4rem; display: flex; flex-direction: column; align-items: center; gap: 1rem;">
            <p style="font-size: 0.75rem; font-weight: 700; letter-spacing: 0.15em; color: #94a3b8; text-transform: uppercase; margin-bottom: 0.25rem;">
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 1rem;">
                ...
                <a href="{{ route('faq.index') }}" style="display: inline-flex; align-items: center; justify-content: center; gap: 0.5rem; background-color: #ffffff; color: #169F81; border: 2px solid #169F81; padding: 1.05rem 2.25rem; border-radius: 50px; font-weight: 800; font-size: 0.88rem; text-decoration: none; text-transform: uppercase; letter-spacing: 0.05em; transition: all 0.3s ease;">
                    📖 Lihat Pusat Bantuan &amp; FAQ Lengkap Seluruh Layanan →
                </a>
            </div>
        </div>
    </div>
