    ...
    <div class="container relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-[820px] mx-auto mb-6 sm:mb-8 md:mb-14">
            ...
            <p class="text-xs sm:text-sm md:text-[1.05rem] text-slate-600 leading-relaxed max-w-2xl mx-auto mb-4 md:mb-8">
                Teknisi profesional kami disiagakan di <strong>3 Target Wilayah Operasional Utama</strong> (Jabodetabek, Semarang, &amp; Bandar Lampung) siap datang cepat tanpa membongkar keramik.
            </p>
            ...
            <div class="grid grid-cols-2 sm:flex sm:flex-wrap justify-center gap-2 sm:gap-3.5 mt-3 md:mt-8 max-w-lg sm:max-w-none mx-auto">
                <div class="bg-white border border-slate-200 shadow-2xs py-1.5 px-2.5 sm:py-2 sm:px-4 rounded-xl text-[11px] sm:text-xs md:text-[0.82rem] font-bold text-slate-700 flex items-center justify-center sm:justify-start gap-1.5">
                    <span>🏛️</span> 3 Hub Utama
                </div>
                <div class="bg-white border border-slate-200 shadow-2xs py-1.5 px-2.5 sm:py-2 sm:px-4 rounded-xl text-[11px] sm:text-xs md:text-[0.82rem] font-bold text-slate-700 flex items-center justify-center sm:justify-start gap-1.5">
                    <span>📍</span> 15 Kota &amp; Kabupaten
                </div>
        ...
        @php
            $coverageHubs = [
                [
                    'province'    => 'Jabodetabek (DKI, Banten, Jabar)',
                    'cities'      => 'Jakarta, Bogor, Depok, Tangerang, BSD, & Bekasi',
                    ...
                    'highlights'  => ['Jakarta', 'Bogor', 'Depok', 'Tangerang / BSD', 'Bekasi / Cikarang'],
                    'service'     => 'Tim standby 24 jam untuk perumahan, apartemen, mall, resto, & kawasan industri MM2100.',
                    'slug'        => 'jakarta-selatan',
                    'cta'         => 'Hub Jabodetabek'
                ],
                [
                    'province'    => 'Semarang (Jawa Tengah)',
                    'cities'      => 'Kota Semarang & Area Sekitarnya',
                    'status'      => 'Cabang Operasional Utama',
                    'badge_theme' => 'blue',
                    'image'       => asset('assets/wilayah/jawa-tengah/jasa-saluran-pipa-mampet-kota-lama-semarang-jawa-tengah-rootera-plumbing-16.webp'),
                    'highlights'  => ['Simpang Lima', 'Tembalang', 'Banyumanik', 'Pedurungan', 'Semarang Barat'],
                    'service'     => 'Rooter drain cleaner & maintenance plumbing pabrik, hotel, & rumah tinggal area Semarang.',
                    'slug'        => 'semarang',
                    'cta'         => 'Hub Semarang'
                ],
                [
                    'province'    => 'Bandar Lampung (Sumatera)',
                    'cities'      => 'Kota Bandar Lampung & Sekitarnya',
                    ...
                    'highlights'  => ['Kedaton', 'Rajabasa', 'Tanjung Karang', 'Teluk Betung', 'Way Halim'],
                    'service'     => 'Cabang resmi Sumatera untuk hunian, ruko, & instansi di Kota Bandar Lampung.',
                    'slug'        => 'bandar-lampung',
                    'cta'         => 'Hub Bandar Lampung'
                ],
            ];
        @endphp
        ...
        <div class="flex items-center justify-between sm:hidden mb-2 px-1">
            <span class="text-[11px] font-bold text-emerald-700 flex items-center gap-1">
                ...
                Geser kesamping untuk wilayah lain (3 Hub Target)
            </span>
        ...
        <div id="areas-slider-container"
            ...
            <div class="w-[82vw] min-w-[82vw] sm:min-w-0 max-w-[320px] sm:w-auto shrink-0 snap-center sm:snap-align-none flex flex-col">
