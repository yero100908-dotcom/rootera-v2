...
<section class="bg-gradient-to-r from-slate-950 via-blue-950 to-slate-950 text-white text-center px-4 sm:px-6 lg:px-8 pt-14 pb-28 lg:pb-16">
    <div class="max-w-2xl mx-auto">
        ...
        <a href="https://wa.me/{{ $city->whatsapp_number ?? '6281385404000' }}?text={{ urlencode('Halo Rootera, saluran saya mampet di ' . $locationName . '. Tolong bantu kirim teknisi sekarang.') }}"
           target="_blank"
