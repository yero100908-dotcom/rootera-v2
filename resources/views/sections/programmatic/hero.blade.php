...
<section class="relative overflow-hidden bg-slate-950 text-white pt-10 pb-16 lg:pt-14 lg:pb-20">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Main 2-Column Desktop Grid / 1-Column Mobile -->
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            
            <!-- Left Column: Headline, Live SLA Badge, Subtitle & CTAs -->
            ...
            <!-- Right Column (Desktop Only): Floating Glassmorphism Feature Card -->
            <div class="lg:col-span-5 hidden lg:block">
                <div class="relative rounded-2xl bg-slate-900/60 backdrop-blur-xl border border-white/20 p-6 lg:p-7 shadow-2xl shadow-slate-950/80 text-white space-y-5">
                    ...
                    <div class="flex items-center justify-between pb-3 border-b border-white/10">
                        <span class="text-xs font-bold uppercase tracking-wider text-emerald-400 flex items-center gap-1.5">
                            ...
                            Standar Utama Rootera
                        </span>
                        <span class="text-xs text-slate-300 font-medium">3 Pilar Garansi</span>
                    </div>

                    <!-- Item 1: Tanpa Bongkar -->
                    <div class="flex items-start gap-3.5">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-white mb-0.5">100% Tanpa Bongkar Lantai</h3>
                            <p class="text-xs text-slate-300 leading-relaxed">Pembersihan dengan Mesin Flexible Rotary Spiral Ridgid tanpa merusak ubin & struktur keramik.</p>
                        </div>
                    </div>

                    <!-- Item 2: Garansi Resmi -->
                    <div class="flex items-start gap-3.5">
                        <div class="w-10 h-10 rounded-xl bg-blue-500/20 border border-blue-500/40 flex items-center justify-center text-blue-400 text-lg shrink-0">
                            🛡️
                        </div>
                        <div>
                            <h3 class="text-sm font-bold text-white mb-0.5">Garansi Resmi 30 Hari</h3>
                            <p class="text-xs text-slate-300 leading-relaxed">Jaminan pengerjaan ulang gratis jika saluran kembali mampet dalam masa garansi resmi.</p>
                        </div>
                    </div>

                    <!-- Item 3: Spiral Rotary Industrial Standard -->
                    <div class="flex items-start gap-3.5">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-white mb-0.5">Alat Rotary Standar Industri</h3>
                            <p class="text-xs text-slate-300 leading-relaxed">Pengikisan lemak beku & sampah penyumbat tuntas dalam 30 hingga 60 menit oleh teknisi bersertifikat.</p>
                        </div>
                    </div>
                    ...
                    <div class="pt-3 border-t border-white/10 flex items-center justify-between text-xs text-slate-300">
                        <span class="flex items-center gap-1 font-semibold text-amber-400">
                            ★ 4.9/5.0 <span class="text-slate-300 font-normal">(2.300+ Pelanggan Puas)</span>
                        </span>
                        <span class="text-emerald-400 font-medium">Buka 24 Jam Nonstop</span>
                    </div>
