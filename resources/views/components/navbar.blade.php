...
<nav id="navbar" class="navbar relative z-[9999]" role="navigation" aria-label="Navigasi utama">
    <div class="nav-container">
        ...
        <ul class="nav-menu" role="list">
            ...
            <li><a href="{{ route('galeri') }}" class="nav-link {{ request()->routeIs('galeri') ? 'active' : '' }}">Galeri & Dokumentasi</a></li>
    ...
    <div class="mobile-menu" id="mobile-menu" role="dialog" aria-label="Menu mobile">
        <ul role="list">
            ...
            <li><a href="{{ route('galeri') }}" class="mobile-link {{ request()->routeIs('galeri') ? 'active' : '' }}">Galeri & Dokumentasi</a></li>
