        ...
        <div class="pb-10 mb-8 border-b border-slate-800/80 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div class="flex items-center gap-2.5">
                    <a href="https://www.instagram.com/rootera_plumbing/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Rootera" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-[#169F81] text-slate-300 hover:text-white flex items-center justify-center transition-colors">
                    ...
                    <a href="https://www.facebook.com/Rootera.id" target="_blank" rel="noopener noreferrer" aria-label="Facebook Rootera" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-[#1E73D8] text-slate-300 hover:text-white flex items-center justify-center transition-colors">
                    ...
                    <a href="https://www.tiktok.com/@rootera_plumbing" target="_blank" rel="noopener noreferrer" aria-label="TikTok Rootera" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white flex items-center justify-center transition-colors">
