        ...
        <div class="pb-10 mb-8 border-b border-slate-800/80 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div class="flex items-center gap-2 flex-wrap">
                    <a href="https://www.youtube.com/@RooteraPlumbing" target="_blank" rel="noopener noreferrer" aria-label="YouTube Rootera Plumbing" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-[#FF0000] text-slate-300 hover:text-white flex items-center justify-center transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                    <a href="https://www.instagram.com/rootera_plumbing/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Rootera Plumbing" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-[#E4405F] text-slate-300 hover:text-white flex items-center justify-center transition-colors">
                    ...
                    <a href="https://www.tiktok.com/@rooteraplumbing.id" target="_blank" rel="noopener noreferrer" aria-label="TikTok Rootera Plumbing" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-[#00F2FE] text-slate-300 hover:text-white flex items-center justify-center transition-colors">
                    ...
                    <a href="https://x.com/RooteraPlumbing" target="_blank" rel="noopener noreferrer" aria-label="X Twitter Rootera Plumbing" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white flex items-center justify-center transition-colors">
                    ...
                    <a href="https://www.linkedin.com/in/rooteraplumbing/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Rootera Plumbing" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-[#0A66C2] text-slate-300 hover:text-white flex items-center justify-center transition-colors">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.46 10.9v8.37H9.25V10.9H6.46M7.86 6.75a1.45 1.45 0 1 0 0 2.9 1.45 1.45 0 0 0 0-2.9z"/></svg>
                    </a>
                    <a href="https://id.pinterest.com/rooteraplumbing/" target="_blank" rel="noopener noreferrer" aria-label="Pinterest Rootera Plumbing" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-[#E60023] text-slate-300 hover:text-white flex items-center justify-center transition-colors">
                    ...
                    <a href="https://www.facebook.com/people/Jasa-Saluran-Pipa-Mampet/61591857691922/" target="_blank" rel="noopener noreferrer" aria-label="Facebook Rootera Plumbing" class="w-9 h-9 rounded-full bg-slate-800 hover:bg-[#1E73D8] text-slate-300 hover:text-white flex items-center justify-center transition-colors">
