        ...
        <div class="footer-container">
            ...
            <div class="footer-brand">
                <a href="{{ route('home') }}" class="footer-logo" aria-label="ROOTERA Beranda">
                    <span class="logo-root-white">ROOT</span><span class="logo-era-green">ERA</span>
                </a>
                ...
                <div class="footer-social" role="list" aria-label="Media sosial ROOTERA">
                    ...
                    <a href="https://wa.me/6285691779889" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp ROOTERA">
            ...
            <div class="footer-contact" aria-label="Informasi kontak">
                ...
                <address class="footer-address">
                    <div class="contact-item">
                        ...
                        <a href="tel:+6285691779889" class="footer-link">+62 856-9177-9889</a>
                    </div>
                    <div class="contact-item">
