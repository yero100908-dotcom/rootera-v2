    ...
    <div class="footer-body">
        <div class="footer-container">
            {{-- Brand --}}
                ...
                {{-- Social Links --}}
                <ul class="footer-social" aria-label="Media sosial Rootera">
                    <li>
                        <a href="https://www.instagram.com/Rootera_plumbing?igsh=c2NkbXA1b3h6MTVy" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram Rootera">
                    ...
                    <li>
                        <a href="https://www.tiktok.com/@Rootera_plumbing?_r=1&_t=ZS-97nM89aiu5h" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="TikTok Rootera">
