    ...
    <div class="footer-body">
        <div class="footer-container">
            ...
            <div class="footer-brand">
                ...
                {{-- Social Links --}}
                <div class="footer-social" role="list" aria-label="Media sosial Rooterin">
                    <a href="https://www.instagram.com/Rooterin_plumbing?igsh=c2NkbXA1b3h6MTVy" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram Rooterin">
                    ...
                    <a href="https://facebook.com/Rooterin.id" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Facebook Rooterin">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                    </a>
                    <a href="https://www.tiktok.com/@Rooterin_plumbing?_r=1&_t=ZS-97nM89aiu5h" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="TikTok Rooterin">
                    ...
                    <a href="https://wa.me/6281385404000" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Rooterin">
            ...
            <div class="footer-contact" aria-label="Informasi kontak">
                ...
                <address class="footer-address">
                    ...
                    <div class="contact-item">
                        ...
                        <a href="mailto:info@Rooterin.id" class="footer-link">info@Rooterin.id</a>
                    </div>
                    <div class="contact-item">
        ...
        <div class="footer-bottom">
            <p>&copy; {{ date('Y') }} <strong>Rooterin</strong>.  Developed by Desty Mikayla Ariana & Yero Virdhan Akifan </p>
            <p></p>
        </div>
    </div>
</footer>
