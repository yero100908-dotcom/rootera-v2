...
<section class="hero" aria-label="Hero section">
    ...
    <div class="hero-container">
        <div class="hero-content">
            ...
            <p class="hero-desc">Rooterin hadir dengan teknologi modern untuk membersihkan pipa dan saluran tersumbat secara profesional, cepat, dan bergaransi — tanpa merusak struktur bangunan Anda.</p>
            <div class="hero-actions">
                <a href="https://wa.me/6281385404000?text=Halo%20Rooterin%2C%20saya%20butuh%20bantuan%20saluran%20mampet." class="btn btn-primary" target="_blank" rel="noopener">
        ...
        <div class="hero-visual" aria-hidden="true">
            <picture>
                ...
                <img src="{{ asset('images/JnJ.jpeg') }}" alt="Pengerjaan Rooterin" style="width: 100%; border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.15); object-fit: cover; display: block; border: 4px solid rgba(255,255,255,0.1);" />
            </picture>
