...
<div class="relative overflow-hidden bg-gradient-to-br from-[#0A2E78] to-[#0d3a94] pt-16 pb-24 md:pt-24 md:pb-32 text-center">
    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-4">Tentang <span class="text-[#6ee7cc]">Rooterin</span></h1>
        ...
        <div class="w-full max-w-4xl mx-auto text-center flex flex-col items-center justify-center px-4 py-8">
            ...
            <div class="w-full max-w-3xl mx-auto bg-slate-50 border border-slate-200 rounded-2xl p-6 text-left mt-8 mb-4">
                ...
                <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">
                    Rooterin tidak berdiri dari nol. Kami berdiri kokoh di atas fondasi <strong>J&J Group (Jawa & Jaya Rooter)</strong>—pionir layanan drainase nasional dengan rekam jejak lebih dari 10 tahun dalam menangani berbagai kasus pipa tersumbat di sektor rumah tangga hingga jaringan komersial dan korporat. Dari warisan pengalaman berharga ini, Rooterin merumuskan Standar Operasional Prosedur (SOP) baru yang lebih segar, sistematis, dan didukung alat modern untuk memberikan jaminan layanan terbaik bagi Anda.
                </p>
            </div>
...
<section class="py-12 md:py-20 bg-white" aria-labelledby="zones-heading">
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mx-auto flex flex-col items-center mb-10 md:mb-14">
            ...
            <p class="text-sm sm:text-base text-slate-600 leading-relaxed mt-3 max-w-2xl mx-auto text-center">Dari hunian pribadi hingga area industri — tim Rooterin siap hadir di mana Anda membutuhkan.</p>
        </div>
        <div class="flex flex-wrap justify-center gap-6 mt-8 w-full max-w-6xl mx-auto">
            ...
            $zoneIcons = [
                ...
                'building' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>',
                'store' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><line x1="9" y1="22" x2="9" y2="12"/><line x1="15" y1="22" x2="15" y2="12"/><line x1="9" y1="12" x2="15" y2="12"/></svg>',
                'office' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',
                'factory' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>',
                'cafe' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/><line x1="6" y1="1" x2="6" y2="4"/><line x1="10" y1="1" x2="10" y2="4"/><line x1="14" y1="1" x2="14" y2="4"/></svg>',
            ];
            @endphp
            @forelse($sectors as $i => $sector)
            <div class="zone-card fade-in w-full sm:w-[calc(50%_-_12px)] lg:w-[calc(33.33%_-_16px)] max-w-[340px] mx-auto" style="animation-delay:{{ $i * 0.08 }}s">
                <div class="zone-icon">
                    {!! $zoneIcons[$sector->icon] ?? $zoneIcons['home'] !!}
                </div>
                <h3 class="text-base sm:text-lg font-bold text-slate-900 mb-2 mt-4">{{ $sector->sector_name }}</h3>
                <p class="text-xs sm:text-sm text-slate-600 leading-relaxed">{{ $sector->description }}</p>
            </div>
            @empty
            <div class="w-full text-center py-8">
                <p class="text-slate-500">Data sektor layanan belum tersedia.</p>
            </div>
            @endforelse
        </div>
    </div>
