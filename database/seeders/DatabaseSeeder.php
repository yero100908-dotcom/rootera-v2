...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $areas = [
            ...
            ['name' => 'Semarang',    'slug' => 'semarang',    'province' => 'Jawa Tengah',             'description' => 'Tim profesional ROOTERA siap melayani Kota Semarang dan daerah sekitarnya.', 'sort_order' => 3, 'meta_title' => 'Jasa Pipa Mampet Semarang | ROOTERA', 'meta_description' => 'ROOTERA Semarang siap membantu atasi saluran mampet and masalah pipa Anda.'],
            ...
            ['name' => 'Bandung',       'slug' => 'bandung',       'province' => 'Jawa Barat',                 'description' => 'Tim ROOTERA melayani Kota Bandung dan area sekitar provinsi Jawa Barat.', 'sort_order' => 6, 'meta_title' => 'Jasa Pipa Mampet Bandung | ROOTERA', 'meta_description' => 'ROOTERA Bandung siap bantu atasi masalah pipa dan saluran Anda.'],
            ['name' => 'Solo',        'slug' => 'solo',        'province' => 'Jawa Tengah',             'description' => 'Layanan pelancar pipa mampet dan saluran tersumbat bergaransi di Kota Surakarta / Solo.', 'sort_order' => 7, 'meta_title' => 'Jasa Pipa Mampet Solo | ROOTERA', 'meta_description' => 'ROOTERA Solo siap membantu atasi saluran mampet, wastafel tersumbat, dan kran bermasalah.'],
        ];
